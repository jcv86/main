...
assert.ok(authMiddleware.includes('classifyAuthState'))
assert.ok(authMiddleware.includes("state === 'signed_out'"))
assert.ok(authMiddleware.includes("state === 'invalid_session'"))
assert.ok(authMiddleware.includes("'resolve_pilot_access'"))
