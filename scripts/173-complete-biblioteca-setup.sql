-- Configuración completa de la biblioteca con datos de ejemplo
-- Complete library setup with sample data

-- 1. Asegurar que todas las tablas existen con estructura correcta
...
CREATE TABLE IF NOT EXISTS user_reading_progress (
    ...
    book_id INTEGER NOT NULL REFERENCES knowledge_base(id),
...
CREATE INDEX IF NOT EXISTS idx_user_reading_progress_user_status ON user_reading_progress(user_email, status);
