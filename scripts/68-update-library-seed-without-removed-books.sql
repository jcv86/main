-- Update the library seed data to only include operational books
-- Remove Inteligencia Emocional and Lean In from future seeds
...
-- Insert only operational books (excluding Inteligencia Emocional and Lean In)
...
-- Keep the existing chapters for Hábitos Atómicos and Los 7 Hábitos
...
-- Verify the cleanup
SELECT 'Books remaining:' as info, COUNT(*) as count FROM public.library_books
UNION ALL
SELECT 'Chapters remaining:' as info, COUNT(*) as count FROM public.library_book_chapters;
