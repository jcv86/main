-- Fix CV tables by dropping and recreating them properly
-- This script ensures all columns exist correctly
...
BEGIN
    ...
    IF travis_user_id IS NOT NULL THEN
        ...
        VALUES 
        (travis_user_id, 'Senior Software Engineer & Founder', 'DespegaTuCarrera', 'Santiago, Chile', '2023-01', '', true, 'Lidero el desarrollo de la plataforma de desarrollo profesional con IA más innovadora de Chile, enfocada en ayudar a profesionales a acelerar sus carreras.', ARRAY['Arquitectura de sistema de IA para evaluaciones de personalidad', 'Implementación de tests DISC con procesamiento de audio', 'Desarrollo de recomendaciones personalizadas con ML', 'Liderazgo técnico de equipo de 5 desarrolladores']),
        ...
        RAISE NOTICE 'Sample CV data inserted successfully for travis@nuanu.com';
    ELSE
