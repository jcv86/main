...
const DOMAIN_TESTS: Record<string, EvidenceLevel> = {
  ...
  'scripts/check-a1-a2-a3-journey-contract.ts': 'mixed_runtime_and_source',
  'scripts/check-a3-active-completion-contract.ts': 'mixed_runtime_and_source',
  'scripts/check-a3-draft-isolation-contract.ts': 'mixed_runtime_and_source',
  ...
  'scripts/check-coaching-api-auth-contract.ts': 'source_only',
  ...
  'scripts/check-observability-p0-contract.ts': 'source_only',
  'scripts/check-rls-p1-contract.ts': 'source_only',
  'scripts/check-rls-p2-contract.ts': 'source_only',
  'scripts/check-rls-p3-contract.ts': 'source_only',
  ...
  'scripts/check-public-agentos-command-retirement-contract.ts': 'source_only',
  'scripts/check-auto-detection-webhook-retirement-contract.ts': 'source_only',
  ...
  'scripts/check-agentos-dev-seed-retirement-contract.ts': 'source_only',
  'scripts/check-global-not-found-contract.ts': 'source_only',
  'scripts/check-a4-canonical-entry-contract.ts': 'source_only',
  'scripts/check-a2-draft-isolation-contract.ts': 'source_only',
}
...
assert.equal(Object.keys(DOMAIN_TESTS).length, 49)
assert.deepEqual(counts, {
  runtime_only: 1,
  mixed_runtime_and_source: 24,
  source_only: 24,
})
