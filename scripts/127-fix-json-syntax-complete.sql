...
-- Insert demo results with simple JSON structure
...
VALUES (
    ...
    'soft-skills', 
    85, 
    '{"overall_score": 85, "communication": 88, "leadership": 82, "teamwork": 90, "problem_solving": 85, "adaptability": 87, "emotional_intelligence": 92, "time_management": 78, "critical_thinking": 83, "creativity": 80}'::jsonb,
    NOW() - INTERVAL '2 days', 
    8
);
