...
-- Delete existing demo results to avoid duplicates
DELETE FROM test_results WHERE user_email = 'demo@example.com' AND test_type = 'soft-skills';

-- Insert demo results with simple JSONB casting (no complex nested structures)
INSERT INTO test_results (user_email, test_name, test_type, score, results, completed_at, duration_minutes) 
VALUES (
    'demo@example.com', 
...
SELECT 'Soft Skills test setup completed successfully with proper JSON formatting' as status;
