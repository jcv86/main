...
-- Insert knowledge base articles using dollar-quoting to handle special characters
...
(
  ...
  $CONTENT$# Especificación Técnica DTC - Plataforma de Desarrollo de Carrera
