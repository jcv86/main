...
-- Now insert demo results with proper JSON formatting
...
'{"overall_score": 85, "competencies": {"communication": 88, "leadership": 82, "teamwork": 90, "problem-solving": 85, "adaptability": 87, "emotional-intelligence": 92, "time-management": 78, "critical-thinking": 83, "creativity": 80}, "strengths": ["Inteligencia Emocional", "Trabajo en Equipo", "Comunicación"], "development_areas": ["Gestión del Tiempo", "Creatividad"], "recommendations": ["Considera usar técnicas de gestión del tiempo como la matriz de Eisenhower para priorizar tareas", "Practica técnicas de pensamiento lateral y brainstorming para generar ideas innovadoras", "Mantén tus fortalezas en inteligencia emocional y trabajo en equipo para liderar iniciativas", "Busca oportunidades para aplicar tu creatividad en proyectos de mejora de procesos"]}', 
