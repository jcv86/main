...
assert.ok(page.includes('Evidencia, no un porcentaje mágico'))
assert.ok(page.includes('Publicación original'))
assert.ok(page.includes('No afirmamos cobertura completa'))
