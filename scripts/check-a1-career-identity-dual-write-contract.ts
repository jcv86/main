...
const migration = readFileSync('supabase/migrations/20260804070000_a1_career_identity_dual_write.sql', 'utf8')
const permissionMigration = readFileSync('supabase/migrations/20260804125500_a1_career_identity_revoke_anon.sql', 'utf8')
...
reject(route, /\.from\(['"]a1_cerebral_assessment['"]\)\s*\.insert/s, 'Route must not bypass the atomic RPC with a direct A1 insert')
