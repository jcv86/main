...
-- PSYCHOLOGY & DECISION MAKING (10 books)
...
('The Hero with a Thousand Faces', 'Monomito', 'El patrón universal de la aventura del héroe. Campbell presenta el monomito, la estructura narrativa común encontrada en mitos y historias de todas las culturas, influyendo profundamente en la narrativa moderna.', 'Joseph Campbell', ARRAY['monomito', 'héroe', 'mitos', 'narrativa', 'universal'], 'hero-thousand-faces', 0),
