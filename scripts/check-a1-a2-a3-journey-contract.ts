...
assert.ok(a1Page.includes('role="group"'))
assert.ok(a1Page.includes('aria-labelledby={`a1-question-${q.id} a1-more-label`}'))
assert.ok(a1Page.includes('aria-labelledby={`a1-question-${q.id} a1-less-label`}'))
assert.ok(a1Page.includes('aria-pressed={more[q.id] === option.texto}'))
assert.ok(a1Page.includes('aria-pressed={less[q.id] === option.texto}'))
assert.ok(a1Page.includes('role="alert"'))
assert.ok(a1Page.includes('aria-live="assertive"'))
assert.ok(a1Page.includes('errorRef.current?.focus()'))
assert.ok(a1Page.includes('focus-visible:ring-2'))
assert.ok(a1Page.includes('p-5 mb-8 shadow-lg sm:p-10'))
...
const redirectLogic = source('lib/redirect-logic.ts')
...
assert.ok(a1Report.includes('Informe profesional de autoconocimiento'))
assert.ok(a1Report.includes('A2 · Traducir'))
assert.ok(a1Report.includes('A3 · Practicar'))
assert.ok(a1Report.includes('A4 · Observar'))
assert.ok(a1Report.includes('Metodología, alcance y límites'))
...
assert.ok(c2Route.includes('conozcamonos_2_completed: true'))
assert.ok(!c2Route.includes('onboarding_conozcamonos_2_completed'))
assert.ok(!a1ReportLayout.includes('onboarding_conozcamonos_2_completed'))
assert.ok(!transitionService.includes('onboarding_conozcamonos_2_completed'))
assert.ok(!redirectLogic.includes('onboarding_conozcamonos_2_completed'))
