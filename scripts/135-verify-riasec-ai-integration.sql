-- Verify and fix RIASEC AI integration
...
-- Insert enhanced RIASEC questions (25 multiple choice + 5 open-ended = 30 total)
...
-- Insert comprehensive RIASEC test result with open-ended responses
...
-- Generate AI insights specifically for RIASEC
INSERT INTO ai_insights (user_email, insight_type, insight_title, insight_content, confidence_score, source_tests) VALUES
('travis@dtcfinal.com', 'career', 'Perfil IEA - Innovador Estratégico', 'Tu código Holland IEA (Investigativo-Emprendedor-Artístico) representa una combinación poderosa para roles de liderazgo en innovación. Tus respuestas abiertas confirman una preferencia por el trabajo sistémico que combina análisis profundo con impacto empresarial tangible.', 96, '["RIASEC"]'),
('travis@dtcfinal.com', 'development', 'Metodología de Investigación Aplicada', 'Tu experiencia desarrollando metodologías que combinan análisis cuantitativo y cualitativo demuestra tu fortaleza IEA. Para maximizar tu potencial, busca roles donde puedas escalar estas metodologías a nivel organizacional.', 92, '["RIASEC"]'),
('travis@dtcfinal.com', 'compatibility', 'Liderazgo en Equipos de Innovación', 'Tu perfil RIASEC indica que destacas liderando equipos multidisciplinarios en proyectos de innovación. Tu necesidad de colaboración energizante combinada con tiempo para análisis profundo es típica de líderes de innovación exitosos.', 94, '["RIASEC"]'),
('travis@dtcfinal.com', 'personality', 'Pensador Sistémico Emprendedor', 'Tus intereses vocacionales revelan un pensador sistémico natural con fuerte orientación emprendedora. Tu capacidad para conectar investigación con resultados empresariales te posiciona idealmente para roles de consultoría estratégica o liderazgo de innovación.', 93, '["RIASEC"]');
