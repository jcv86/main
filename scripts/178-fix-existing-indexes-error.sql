-- Arreglar error de índices existentes y configurar sistema completo
-- Fix existing indexes error and set up complete system

-- 1. Eliminar todos los índices existentes para recrear correctamente
DROP INDEX IF EXISTS idx_knowledge_base_category;
DROP INDEX IF EXISTS idx_knowledge_base_read_count;
DROP INDEX IF EXISTS idx_knowledge_base_created_at;
DROP INDEX IF EXISTS idx_user_reading_progress_user_email;
DROP INDEX IF EXISTS idx_user_reading_progress_book_id;
DROP INDEX IF EXISTS idx_user_reading_progress_status;
DROP INDEX IF EXISTS idx_user_reading_progress_last_read;
DROP INDEX IF EXISTS idx_user_bookmarks_user_email;
DROP INDEX IF EXISTS idx_user_bookmarks_book_id;
DROP INDEX IF EXISTS idx_user_bookmarks_created;
DROP INDEX IF EXISTS idx_reading_sessions_user_email;
DROP INDEX IF EXISTS idx_reading_sessions_book_id;
DROP INDEX IF EXISTS idx_reading_sessions_start;
DROP INDEX IF EXISTS idx_book_reviews_book_id;
DROP INDEX IF EXISTS idx_book_reviews_rating;
DROP INDEX IF EXISTS idx_book_reviews_created;
DROP INDEX IF EXISTS idx_reading_goals_user_email;
DROP INDEX IF EXISTS idx_reading_goals_status;
DROP INDEX IF EXISTS idx_reading_goals_period;

-- 2. Eliminar tablas existentes para recrear con estructura correcta
...
-- 3. Eliminar funciones existentes para recrear con tipos correctos
...
-- 4. Asegurar que knowledge_base existe con estructura correcta
...
-- 5. Crear tabla de progreso de lectura de usuarios
...
-- 6. Crear tabla de bookmarks de usuarios
...
-- 7. Crear tabla de sesiones de lectura
...
-- 8. Crear tabla de reseñas de libros
...
-- 9. Crear tabla de objetivos de lectura
...
-- 10. Crear índices para optimizar consultas (usando IF NOT EXISTS implícito)
...
-- 11. Crear funciones con tipos correctos
...
-- 12. Confirmar que las tablas se crearon correctamente
SELECT 
