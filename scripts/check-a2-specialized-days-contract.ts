...
const validationIndex = route.indexOf('validateA2SpecializedDaySubmission(day, submission)')
const insertIndex = route.indexOf(".from('a2_user_task_completions').insert")
assert.ok(validationIndex >= 0 && insertIndex >= 0 && validationIndex < insertIndex)
