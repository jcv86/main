...
-- Insert demo results for soft skills test (delete existing first)
...
'{
  ...
  "recommendations": [
    "Considera usar técnicas de gestión del tiempo como la matriz de Eisenhower",
    "Practica técnicas de pensamiento lateral para mejorar la creatividad",
    "Mantén tus fortalezas en inteligencia emocional y trabajo en equipo"
  ]
}', 
