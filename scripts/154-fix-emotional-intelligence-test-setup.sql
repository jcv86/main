-- Fix Emotional Intelligence Test setup - remove ON CONFLICT and ensure proper structure
BEGIN;

-- Ensure test_questions table exists with proper structure
...
-- Ensure test_results table exists with proper structure
...
-- Insert demo results for emotional intelligence test (without ON CONFLICT)
DELETE FROM test_results WHERE user_email = 'demo@example.com' AND test_type = 'emotional-intelligence';
