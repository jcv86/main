      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-xl text-muted-foreground dark:text-white/85 font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="text-center border-2 border-blue/20 dark:border-cyan/50 bg-white dark:bg-background">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground dark:text-white/85 mt-1 font-medium">Recursos</p>
              </CardContent>
            </Card>
            <Card className="text-center border-2 border-blue/20 dark:border-teal-900/50 bg-white dark:bg-background">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground dark:text-white/85 mt-1 font-medium">Categorías</p>
              </CardContent>
            </Card>
            <Card className="text-center border-2 border-green/20 dark:border-emerald-900/50 bg-white dark:bg-background">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground dark:text-white/85 mt-1 font-medium">Gratuitos</p>
              </CardContent>
            </Card>
            <Card className="text-center border-2 border-blue/20 dark:border-blue/50 bg-white dark:bg-background">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground dark:text-white/85 mt-1 font-medium">Verificados</p>
              </CardContent>
            </Card>
          </div>
