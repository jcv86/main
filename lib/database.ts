...
export const libraryBooksData = [
  {
    ...
    pages: 8,
    publishedYear: 2018,
    coverUrl: "/placeholder.svg?height=400&width=300&text=Hábitos%20Atómicos&bg=3b82f6&color=white",
    tags: ["Hábitos", "Productividad", "Autoayuda", "Comportamiento"],
    progress: 65,
    isRecommended: true,
    difficulty: "Intermedio",
    keyTopics: ["Formación de hábitos", "Productividad personal", "Cambio de comportamiento", "Sistemas vs objetivos"],
  },
  {
    id: "2",
    ...
    pages: 7,
    publishedYear: 1989,
    coverUrl: "/placeholder.svg?height=400&width=300&text=7%20Hábitos&bg=1f2937&color=white",
    tags: ["Liderazgo", "Efectividad", "Desarrollo Personal", "Principios"],
    progress: 100,
    isRecommended: true,
    difficulty: "Intermedio",
    keyTopics: ["Liderazgo personal", "Efectividad", "Principios de vida", "Interdependencia"],
  },
  {
    id: "3",
    ...
    pages: 6,
    publishedYear: 2016,
    coverUrl: "/placeholder.svg?height=400&width=300&text=Trabajo%20Profundo&bg=1f2937&color=white",
    tags: ["Concentración", "Productividad", "Trabajo", "Enfoque"],
    progress: 0,
    isRecommended: true,
    difficulty: "Intermedio",
    keyTopics: ["Trabajo profundo", "Concentración", "Productividad cognitiva", "Distracción digital"],
  },
  {
    id: "4",
    ...
    pages: 6,
    publishedYear: 1995,
    coverUrl: "/placeholder.svg?height=400&width=300&text=Inteligencia%20Emocional&bg=10b981&color=white",
    tags: ["Inteligencia Emocional", "Habilidades Blandas", "Comunicación", "Autoconciencia"],
    progress: 80,
    isRecommended: true,
    difficulty: "Intermedio",
    keyTopics: ["Inteligencia emocional", "Autoconciencia", "Habilidades sociales", "Autorregulación"],
  },
  {
    id: "5",
    title: "Lean In",
    ...
    pages: 6,
    publishedYear: 2013,
    coverUrl: "/placeholder.svg?height=400&width=300&text=Lean%20In&bg=ec4899&color=white",
    tags: ["Liderazgo", "Carrera", "Género", "Empoderamiento"],
    progress: 35,
    isRecommended: false,
    difficulty: "Fácil",
    keyTopics: ["Liderazgo femenino", "Desarrollo profesional", "Igualdad de género", "Ambición"],
  },
]
