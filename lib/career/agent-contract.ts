...
export interface AgentRecommendation {
  title: string
  rationale: string
  actionType: "mission" | "practice" | "reflection" | "content" | "review"
  priority: 1 | 2 | 3 | 4 | 5
  skillKeys: string[]
  evidenceIds: string[]
  metadata?: Record<string, unknown>
...
export interface CareerAgent<Input = unknown, Output = unknown> {
  readonly id: string
  readonly version: string
  execute(input: Input, context: CareerContext, career: CareerReadPort): Promise<Output>
}
