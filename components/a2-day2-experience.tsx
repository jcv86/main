...
const TRAVIS_DAY2_DATA = {
  ...
  fragments: [
    {
      id: "1",
      text: "Reduje churn 23% mediante redesign de onboarding",
      category: "achievement",
      goldPiece: true,
    },
    {
      id: "2",
      text: "Presenté roadmap Q3 al CEO con 8 features priorizadas",
      category: "achievement",
      goldPiece: true,
    },
    {
      id: "3",
      text: "Conduje 15 entrevistas que cambiaron priorización Q4",
      category: "research",
      goldPiece: false,
    },
    {
      id: "4",
      text: "Diseñé estrategia API que generó $40K MRR partners",
      category: "achievement",
      goldPiece: true,
    },
    {
      id: "5",
      text: "Análisis de pricing que añadió $30K MRR",
      category: "achievement",
      goldPiece: false,
    },
    {
      id: "6",
      text: "GTM de Analytics Dashboard con 35% adoption",
      category: "launch",
      goldPiece: false,
    },
    {
      id: "7",
      text: "Sistema de roadmap transparente, NPS +12",
      category: "process",
      goldPiece: false,
    },
    {
      id: "8",
      text: "Programa retention que bajó churn M4-6 de 8% a 2%",
      category: "achievement",
      goldPiece: false,
    },
  ],
  goldPieces: [
    {
      id: "1",
      text: "Reduje churn 23% mediante redesign de onboarding - +$50K revenue",
    },
    {
      id: "2",
      text: "Roadmap Q3 priorizado por user research - +$80K revenue",
    },
