...
const DISC_DETAILS = {
  D: {
    ...
    color: 'bg-red/10 dark:bg-red/30 text-red-800 dark:text-red-300',
    icon: '⚡',
  ...
  I: {
    ...
    color: 'bg-yellow/10 dark:bg-yellow/30 text-yellow dark:text-yellow-300',
    icon: '🎤',
  ...
  S: {
    ...
    color: 'bg-green/10 dark:bg-green/30 text-green dark:text-green-300',
    icon: '🤝',
  ...
  C: {
    ...
    color: 'bg-blue/10 dark:bg-blue/30 text-blue dark:text-blue-300',
    icon: '🎯',
