...
import { Brain, Target, BookOpen, TrendingUp, ChevronRight } from "lucide-react"
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {testResults.test_results && Object.entries(testResults.test_results).map(([key, value]: any) => (
