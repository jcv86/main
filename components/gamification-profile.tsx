      ...
      <Card className="relative overflow-hidden">
        ...
        <div className="relative p-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-sm font-semibold text-gray-600 uppercase mb-2">Current Level</p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Total XP: {totalXp.toLocaleString()}</p>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-center justify-between mb-6">
          {['Bronze', 'Silver', 'Gold', 'Platinum', 'Diamond'].map((lvl, idx) => (
            <div key={lvl} className="flex flex-col items-center">
              ...
              <p className="text-xs font-semibold text-gray-600 mt-2">{lvl}</p>
