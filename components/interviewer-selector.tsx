          ...
          {INTERVIEWERS.map(interviewer => (
            ...
            >
              ...
              <div className="relative space-y-3 text-center">
                <div className="relative w-20 h-20 rounded-full mx-auto overflow-hidden shadow-lg border-2 border-white/20">
                  <Image
                    src={interviewer.image}
                    alt={interviewer.name}
                    fill
                ...
                <div>
                  <div className="font-bold text-white">{interviewer.name}</div>
                  <div className="text-xs text-white/80">{interviewer.role}</div>
                </div>
                {value === interviewer.id && (
