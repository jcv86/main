...
export function DocumentEditor({ document, userId, onSave, onCancel }: DocumentEditorProps) {
  ...
  return (
    <div className="bg-stone-900 rounded-lg p-6 space-y-4">
      <h3 className="text-lg font-semibold text-[rgb(80,160,170)]-400">
      ...
      <div className="flex gap-2 pt-4">
        <Button onClick={handleSave} disabled={isSaving} className="flex-1 bg-[rgba(80,160,170,0.5)]-500 hover:bg-[rgba(80,160,170,0.5)]-600 text-white">
          {isSaving ? (
            <>
