    ...
    <div className="max-w-3xl mx-auto px-4 space-y-6">
      ...
      >
        <div className="flex items-center justify-center mb-4">
          <CheckCircle className="w-12 h-12" style={{ color: 'rgb(80, 160, 170)' }} />
        </div>

        <h2 className="text-2xl font-bold text-white">¡DÍA 2 APROBADO!</h2>

        <div className="space-y-1">
          <p className="text-white/80">Bóveda creada y evidencia recolectada</p>
          <p className="text-sm text-white/60">+50 XP ganado</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="space-y-2 text-sm text-white/70">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-white">{vaultData.fragments?.length || 0}</span>
          </div>
          <div className="flex items-center justify-between">
            <p>Piezas de Oro:</p>
            <span className="text-white">{vaultData.goldPieces?.length || 0}</span>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <p className="text-sm text-white/70">
          Días 3-4 analizaremos el mercado y cruzaremos tu evidencia con lo que pide el mercado. 
          Tu bóveda será la fuente de verdad para todo lo que construyamos adelante.
        </p>
      </div>
