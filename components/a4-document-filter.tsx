  ...
  return (
    <div className="flex gap-3 flex-wrap">
      <Select onValueChange={value => onFilterTypeChange(value === 'all' ? null : value)}>
        <SelectTrigger className="w-[200px] border-[rgb(80,160,170)] bg-black text-gray-300">
          <SelectValue placeholder="Filtrar por tipo..." />
        </SelectTrigger>
        <SelectContent className="bg-stone-900 border-[rgb(80,160,170)]">
      ...
      }} className="border-[rgb(80,160,170)] text-gray-300 hover:bg-stone-900">
