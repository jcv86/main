...
export function AnalysisResults({ sessionId }: AnalysisResultsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-2 border-training/30 bg-gradient-to-r from-training/5 to-transparent">
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Badge className="bg-training text-black font-bold">{analysis.overall_score}/100</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      {/* Visual Analysis - Training color accents */}
      <Card className="border-training/20">
        <CardHeader>
      ...
      {/* Audio Analysis - Training color accents */}
      <Card className="border-training/20">
        <CardHeader>
      ...
      <Card className="border-training/20">
        ...
        <CardContent className="space-y-3">
          <div className="flex justify-between items-center p-3 bg-training/5 border border-training/10 rounded-lg">
            ...
            <Badge className="bg-training text-black font-bold">{analysis.coherence_analysis.visual_audio_alignment}%</Badge>
          </div>
          <p className="text-sm text-muted-foreground">{analysis.coherence_analysis.message_consistency}</p>
        </CardContent>
      </Card>

      {/* Key Strengths - Training accent */}
      ...
      {/* Personalized Recommendations - Training color */}
