...
| DTC-QA-01 | Existe una puerta reproducible de TypeScript, contratos críticos y build | `npm run quality:gate`; #166 `e888ac1` 10/10 workflows PASS + Vercel READY; #167–#170 mantienen regresión crítica verde en sus candidatos exactos. | QA | Ninguna | verified | sí |
...
| DTC-SEC-03 | El resto del esquema legacy queda clasificado y cerrado por oleadas compatibles | Waves 2–3 preparadas: las 195 relaciones detectadas quedan clasificadas; falta preflight completo de compatibilidad, aplicación autorizada y verificación remota. | Supabase | Aprobación y verificación remota | in_progress | sí |
...
- PR #170 `e7bcd4975a0a977c4ccead52ea307c4398709ff8`: reanudación canónica única; 5 workflows relevantes PASS y Vercel `dpl_BBCCcon8ihFYyZ1RHEdXy2eCo6pb` READY.
