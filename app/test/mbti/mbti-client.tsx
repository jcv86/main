...
export default function MBTITestClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple/5 to-blue/5 dark:from-slate-900 dark:to-slate-800 p-4">
          ...
          <RadioGroup value={answers[currentQuestion] || ""} onValueChange={handleAnswer}>
            <div className="space-y-3">
              {question.options?.map((option, idx) => (
                <Label key={idx} className="flex items-center gap-3 cursor-pointer p-3 rounded-lg hover:bg-muted/10 dark:hover:bg-slate-800">
