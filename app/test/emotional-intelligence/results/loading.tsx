    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 p-4">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="h-10 bg-muted/20 rounded-lg w-96 mx-auto mb-4 animate-pulse"></div>
          <div className="h-6 bg-muted/20 rounded-lg w-64 mx-auto animate-pulse"></div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="h-4 bg-muted/20 rounded w-3/4 mb-8 animate-pulse"></div>
              ...
              <div key={index} className="p-6 bg-muted/5 rounded-lg">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="h-12 w-16 bg-muted/20 rounded mb-2 animate-pulse"></div>
                    <div className="h-6 w-20 bg-muted/20 rounded animate-pulse"></div>
                  </div>
                </div>
                <div className="h-4 bg-muted/20 rounded-full animate-pulse"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 pt-8">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-12 w-40 bg-muted/20 rounded-lg animate-pulse"></div>
          ))}
        </div>
