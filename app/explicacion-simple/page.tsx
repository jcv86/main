      ...
      <div className="container mx-auto px-4 py-16 max-w-5xl">
        ...
        <div className="space-y-12">
          ...
          <div className="bg-gradient-to-br from-blue/5 to-purple/5 rounded-2xl p-8 border border-blue/20">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 border-l-4 border-purple/50">
                ...
                <ul className="space-y-2 ml-6 text-gray-700 mb-4">
          ...
          <div className="bg-gradient-to-br from-green/5 to-blue/5 rounded-2xl p-8 border border-green/20">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-6">
                <h3 className="font-bold text-xl text-gray-900 mb-3">Individuos (B2C)</h3>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-white rounded-xl p-6">
                <h3 className="font-bold text-xl text-gray-900 mb-3">Instituciones (B2B)</h3>
                <ul className="space-y-2 text-gray-700">
          ...
          <div className="bg-gradient-to-br from-muted/5 to-gray-50 rounded-2xl p-8 border border-muted/20">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-6">
                <h3 className="font-bold text-lg text-gray-900 mb-3">Frontend</h3>
              ...
              <div className="bg-white rounded-xl p-6">
                <h3 className="font-bold text-lg text-gray-900 mb-3">AI & ML</h3>
                <ul className="space-y-1 text-gray-700">
                  <li>• OpenAI GPT-4</li>
              ...
              <div className="bg-white rounded-xl p-6">
                <h3 className="font-bold text-lg text-gray-900 mb-3">Infrastructure</h3>
                <ul className="space-y-1 text-gray-700">
          ...
          <div className="bg-gradient-to-br from-orange/5 to-amber-50 rounded-2xl p-8 border border-orange-200">
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-xl p-5">
                <p className="font-bold text-lg text-gray-900 mb-2">Q2 2026: Expansión Mobile</p>
                <p className="text-gray-700">Apps iOS/Android + Features de voz</p>
              </div>
              <div className="bg-white rounded-xl p-5">
                <p className="font-bold text-lg text-gray-900 mb-2">Q3-Q4 2026: Enterprise & Multi-idioma</p>
                <p className="text-gray-700">Portales corporativos + Expansión LATAM</p>
              </div>
              <div className="bg-white rounded-xl p-5">
                <p className="font-bold text-lg text-gray-900 mb-2">2027: Integraciones Avanzadas</p>
                <p className="text-gray-700">APIs HR, LinkedIn, plataformas de reclutamiento</p>
              </div>
            </div>
          </div>
