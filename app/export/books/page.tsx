...
export default function BooksExportPage() {
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute("download", "biblioteca-completa-export.csv")
        ...
        <div className="grid gap-6 md:grid-cols-2 mb-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Descarga el archivo CSV completo con todos los libros</CardDescription>
            </CardHeader>
            <CardContent>
              <Button onClick={downloadCSV} className="w-full" size="lg">
                <Download className="mr-2 h-4 w-4" />
                Descargar biblioteca-completa-export.csv
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Copia los datos CSV al portapapeles</CardDescription>
            </CardHeader>
            <CardContent>
              <Button onClick={copyToClipboard} variant="outline" className="w-full bg-transparent" size="lg">
