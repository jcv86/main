      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl shadow-lg p-8 mb-8 border-2 border-red-100">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white rounded-xl p-6">
              <h3 className="text-xl font-bold text-amber-700 mb-3">Falta de Orientación Personalizada</h3>
              <p className="text-slate-700 mb-2">
        ...
        {/* La Solución DTC */}
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-lg p-8 mb-8 border-2 border-blue-100">
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid md:grid-cols-2 gap-3 text-slate-700">
                    <div>
                      <p className="font-semibold text-blue-700">Personalidad y Comportamiento:</p>
                    ...
                    <div>
                      <p className="font-semibold text-blue-700">Habilidades y Vocación:</p>
                      <ul className="space-y-1 ml-4">
            ...
            <div className="bg-white rounded-xl p-6">
              <div className="flex items-start gap-4">
                <div className="bg-purple-100 rounded-lg p-3 shrink-0">
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-lg p-8 mb-8 border-2 border-green-100">
          ...
          <div className="space-y-6">
            ...
            <div className="border-2 border-indigo-200 rounded-xl p-6 bg-indigo-50">
              ...
              <div className="space-y-3 ml-13">
                ...
                <ul className="ml-6 space-y-1 text-slate-600">
        ...
        <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl shadow-lg p-8 mb-8 border-2 border-amber-100">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">🌟 Casos de Uso y Beneficiarios</h2>

          <div className="space-y-4">
            <div className="bg-white rounded-xl p-6">
              <h3 className="text-lg font-bold text-amber-700 mb-2">Universidad del Desarrollo (UDD)</h3>
            ...
            <div className="bg-white rounded-xl p-6">
              <h3 className="text-lg font-bold text-amber-700 mb-2">Universidad de Chile (U. de Chile)</h3>
              <p className="text-slate-700 mb-3">
            ...
            <div className="bg-white rounded-xl p-6">
              <h3 className="text-lg font-bold text-amber-700 mb-2">Pontificia Universidad Católica (PUC)</h3>
              <p className="text-slate-700 mb-3">
            ...
            <div className="bg-white rounded-xl p-6">
              <h3 className="text-lg font-bold text-amber-700 mb-2">Universidades Regionales del CRUCH</h3>
              <p className="text-slate-700 mb-3">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              <div className="bg-blue-100 rounded-full w-12 h-12 flex items-center justify-center font-bold text-blue-700 shrink-0">
                2
              </div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="bg-purple-100 rounded-full w-12 h-12 flex items-center justify-center font-bold text-purple-700 shrink-0">
                3
              </div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="bg-amber-100 rounded-full w-12 h-12 flex items-center justify-center font-bold text-amber-700 shrink-0">
                5
              </div>
              <div>
        ...
        {/* Próximos Pasos */}
        <div className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-lg p-8 text-white mb-8">
