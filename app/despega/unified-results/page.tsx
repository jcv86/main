...
export default function UnifiedTestDashboard() {
  ...
  const getColorClasses = (color: string) => {
    const colors: Record<string, string> = {
      blue: "bg-blue/5 border-blue/30 dark:bg-blue-950/20 dark:border-blue-800",
      purple: "bg-purple/5 border-purple/30 dark:bg-purple-950/20 dark:border-purple-800",
      indigo: "bg-blue/5 border-blue/30 dark:bg-indigo-950/20 dark:border-indigo-800",
  ...
  const getTextColorClasses = (color: string) => {
    const colors: Record<string, string> = {
      blue: "text-blue dark:text-blue-400",
      purple: "text-purple dark:text-purple-400",
