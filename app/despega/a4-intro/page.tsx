        ...
        <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-200 dark:border-red-800">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white">Análisis de Mercado</p>
                      <p className="text-sm text-slate-600 dark:text-slate-400">Salarios, demanda de skills, tendencias de carrera.</p>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg border border-yellow-200 dark:border-yellow-800">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white">Benchmark Competitivo</p>
                      <p className="text-sm text-slate-600 dark:text-slate-400">Cómo te comparas con otros perfiles en el mercado.</p>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white">Decisiones Estratégicas</p>
                      <p className="text-sm text-slate-600 dark:text-slate-400">Recomendaciones personalizadas basadas en tu perfil y mercado.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card className="border-0 shadow-lg bg-slate-900 dark:bg-slate-800">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-slate-400">Cómo funciona tu ejecución continua</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
