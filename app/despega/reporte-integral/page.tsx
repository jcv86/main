...
export default async function ReporteIntegralPage() {
  ...
  const [a1, a2, a3, a4] = await Promise.all([loadA1Report(journey.user.id), loadA2Report(journey.user.id), loadA3Report(journey.user.id), loadA4Report(journey.user.id)])
