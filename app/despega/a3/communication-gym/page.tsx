                ...
                {drill.type === 'recording' && (
                  <>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg p-6 text-center">
                      {isRecording ? (
                        <div className="space-y-4">
                          <div className="w-20 h-20 rounded-full bg-[rgba(80,160,170,0.5)]-500/20 flex items-center justify-center mx-auto animate-pulse">
                            <Mic className="w-10 h-10 text-[rgb(80,160,170)]-400" />
                          </div>
                          ...
                          <Button 
                            ...
                            className="bg-[rgba(80,160,170,0.5)]-500 hover:bg-[rgba(80,160,170,0.5)]-600"
                          >
                            ...
                            <button
                              ...
                              className={`flex-1 px-3 py-2 rounded-lg text-sm transition-all ${
                                assessments[aspect.id] === option
                                  ? i === 0 ? 'bg-[rgba(80,160,170,0.5)]-500/20 text-[rgb(80,160,170)]-400 border border-[rgb(80,160,170)]-500/30' :
