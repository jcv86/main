          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <Card key={item.badge} className="bg-gradient-to-br from-yellow/5 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-yellow/30 dark:border-amber-800">
