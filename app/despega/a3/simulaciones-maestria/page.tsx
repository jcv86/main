...
const GUIDED_INTERVIEW_QUESTIONS = [
  {
    id: 1,
    type: 'intro',
    question: 'Te ves bien en papel, pero la realidad no siempre concuerda. ¿Qué te hace pensar que serás bueno en esto?',
    guidance: '',
    time_limit: 30,
    expected_length: 'short',
    tags: ['Confianza bajo presión', 'Credibilidad']
  },
  {
    id: 2,
    type: 'motivation',
    question: 'He visto a 50 candidatos esta semana con perfil similar. ¿Por qué contratarte a ti?',
    guidance: '',
    time_limit: 45,
    expected_length: 'short',
    tags: ['Diferenciación extrema', 'Assertividad']
  },
  {
    id: 3,
    type: 'achievement',
    question: 'Cuéntame tu mayor fracaso. Y después, por qué aún mereces estar aquí.',
    guidance: '',
    time_limit: 60,
    expected_length: 'medium',
    tags: ['Vulnerabilidad + Fortaleza', 'Recuperación']
  },
  {
    id: 4,
    type: 'challenge',
    question: 'Esta empresa tiene problemas profundos. ¿Cómo los resolverías en tu primer mes?',
    guidance: '',
    time_limit: 60,
    expected_length: 'medium',
    tags: ['Pensamiento estratégico', 'Rapidez de análisis']
  },
  {
    id: 5,
    type: 'learning',
