  ...
  const handleComplete = async () => {
    try {
      await fetch('/api/a3/complete-module', {
        ...
        body: JSON.stringify({ moduleId: 'answer-architecture', xp: MODULE_XP })
      })
      ...
      <div className="container max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Card className="bg-purple-500/10 border-purple-500/30 p-4">
            <p className="text-purple-400 text-xs uppercase mb-2">Self-Introduction Formula</p>
          ...
          <Card className="bg-cyan-500/10 border-cyan-500/30 p-4">
            <p className="text-cyan-400 text-xs uppercase mb-2">Basic STAR Formula</p>
            <p className="text-white/80 text-sm italic">
