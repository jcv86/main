        ...
        <div className="space-y-8">
          <Card className="border-0 shadow-lg">
            <CardHeader className="pb-4">
              <CardTitle className="text-2xl flex items-center gap-2" style={{ fontWeight: 500 }}>
                <Target className="w-6 h-6" style={{ color: 'rgba(170, 70, 170, 0.4)' }} />
                ¿Qué es Entrenamiento Intensivo?
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-white leading-relaxed" style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>
              ...
              <div className="p-6 rounded-xl" style={{ backgroundColor: 'rgba(170, 70, 170, 0.2)' }}>
                <p className="text-white" style={{ fontWeight: 400, fontSize: '18px' }}>
                  <span style={{ color: 'rgba(170, 70, 170)' }}>Tu objetivo aquí:</span> Pasar de "conozco las respuestas" a "puedo responder con seguridad bajo presión".
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader className="pb-4">
              <CardTitle className="text-2xl flex items-center gap-2">
                <CheckCircle2 className="w-6 h-6" style={{ color: 'rgba(170, 70, 170, 0.4)' }} />
                Las 3 Modalidades de Entrenamiento
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="p-4 rounded-[28px]" style={{ backgroundColor: 'rgba(170, 70, 170, 0.2)' }}>
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 w-8 h-8 text-white rounded-full flex items-center justify-center font-bold" style={{ backgroundColor: '#000000' }}>1</div>
                    <div>
                ...
                <div className="p-4 rounded-[28px]" style={{ backgroundColor: 'rgba(170, 70, 170, 0.4)' }}>
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 w-8 h-8 text-white rounded-full flex items-center justify-center font-bold" style={{ backgroundColor: 'rgba(0, 0, 0, 0.80)' }}>2</div>
                    <div>
                ...
                <div className="p-4 rounded-[28px]" style={{ backgroundColor: 'rgba(170, 70, 170, 0.6)' }}>
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 w-8 h-8 text-white rounded-full flex items-center justify-center font-bold" style={{ backgroundColor: 'rgba(0, 0, 0, 0.60)' }}>3</div>
                    <div>
          ...
          <Card className="border-0 shadow-lg bg-muted/90 dark:bg-card">
            <CardHeader className="pb-4">
              <CardTitle className="text-2xl text-white flex items-center gap-2">
                <MessageSquare className="w-6 h-6" style={{ color: 'rgba(170, 70, 170, 0.4)' }} />
                El Ciclo de Mejora
              </CardTitle>
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader className="pb-4">
              <CardTitle className="text-2xl flex items-center gap-2">
                <Zap className="w-6 h-6" style={{ color: 'rgba(170, 70, 170, 0.6)' }} />
                Lo que Practicarás
              </CardTitle>
            </CardHeader>
          ...
          <div className="p-8 rounded-[2px] shadow-lg" style={{ backgroundColor: 'rgba(170, 70, 170, 0.2)' }}>
