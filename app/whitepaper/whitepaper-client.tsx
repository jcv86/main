    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <header className="bg-white border-b border-muted/20 sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 max-w-7xl flex items-center justify-between">
          ...
          <h1 className="text-xl font-bold text-foreground">Technical Whitepaper</h1>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        {/* Table of Contents */}
        <section className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          <h2 className="text-3xl font-bold mb-6 text-foreground">Table of Contents</h2>
          <nav className="grid md:grid-cols-2 gap-4">
            {[
              ...
              >
                ...
                <span className="text-muted group-hover:text-purple transition-colors">{section}</span>
              </a>
            ))}
          </nav>
        </section>
        ...
        <section id="section-1" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          <h2 className="text-3xl font-bold mb-6 text-foreground">1. Technical Architecture</h2>
          ...
          <div className="bg-muted/5 rounded-lg p-6 border border-muted/20 mb-6">
            <ul className="space-y-3 text-muted">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong className="text-foreground">Server-First Architecture:</strong> Leverages Next.js 15 server
              ...
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-purple rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong className="text-foreground">RESTful API Design:</strong> Organized routes by resource with
              ...
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-purple rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong className="text-foreground">Database Design:</strong> PostgreSQL with pgvector, Row Level
              ...
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 bg-purple rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong className="text-foreground">Edge Functions:</strong> Global low-latency responses via Vercel
                  Edge Network
                </span>
              </li>
            </ul>
        ...
        <section id="section-2" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          <h2 className="text-3xl font-bold mb-6 text-foreground">2. Core Features</h2>

          <div className="space-y-6">
            <div className="border-l-4 border-purple pl-6 py-2">
              <h3 className="text-xl font-semibold mb-2 text-foreground">Landing Page & SEO</h3>
            ...
            <div className="border-l-4 border-blue pl-6 py-2">
              <h3 className="text-xl font-semibold mb-2 text-foreground">Authentication System</h3>
              <p className="text-muted">
            ...
            <div className="border-l-4 border-emerald-600 pl-6 py-2">
              <h3 className="text-xl font-semibold mb-2 text-foreground">User Dashboard</h3>
              <p className="text-muted">
        ...
        <section id="section-3" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          <h2 className="text-3xl font-bold mb-6 text-foreground">3. Psychometric Assessment System</h2>
        ...
        <section id="section-5" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          <h2 className="text-3xl font-bold mb-6 text-foreground">5. Professional Library</h2>
          ...
          <div className="bg-green/5 rounded-lg p-6 border border-emerald-100">
            <h3 className="text-xl font-semibold mb-3 text-foreground">Reading Features</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
        ...
        <section id="section-6" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          <h2 className="text-3xl font-bold mb-6 text-foreground">6. Administrative Systems</h2>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex items-center gap-3 bg-muted/5 rounded-lg p-4 border border-muted/20">
                ...
                <span className="text-muted font-medium">{system}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="section-7" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-green/5 rounded-lg p-5 border border-emerald-100">
              <h4 className="font-bold mb-3 text-foreground">Indexes</h4>
            ...
            <div className="bg-blue/5 rounded-lg p-5 border border-blue/10">
              <h4 className="font-bold mb-3 text-foreground">Materialized Views</h4>
              <ul className="space-y-2 text-muted text-sm">
        ...
        <section id="section-9" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          <h2 className="text-3xl font-bold mb-6 text-foreground">9. Performance & Monitoring</h2>
        ...
        <section id="section-10" className="mb-12 bg-white rounded-xl p-8 shadow-sm border border-muted/20">
          ...
          <div className="bg-gradient-to-r from-purple/10 to-blue/10 rounded-xl p-6 mb-8 border border-purple/20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-xl font-bold text-foreground">Official Platform Launch: Q1 2026</h3>
            </div>
            <p className="text-muted">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-purple pl-6">
              <h3 className="text-xl font-bold mb-3 text-foreground">Q2 2026</h3>
              <ul className="space-y-2 text-muted">
            ...
            <div className="border-l-4 border-blue pl-6">
              <h3 className="text-xl font-bold mb-3 text-foreground">Q3-Q4 2026</h3>
              <ul className="space-y-2 text-muted">
            ...
            <div className="border-l-4 border-emerald-600 pl-6">
              <h3 className="text-xl font-bold mb-3 text-foreground">2027 & Beyond</h3>
              <ul className="space-y-2 text-muted">
